...
This optimization is simple to implement by checking that the absolute
difference between the loop counter variables \verb|i| and \verb|j| does not
exceed a fixed bandwidth threshold value. In a parallel programming environment
such as CUDA, this allows for the computation of the warping path using fewer
threads. (NOTE: only works for square matrices i.e. equal length ts. need to
describe algorithm for rectangular)
...
TODO: add a figure with visualization of Sakoe-Chiba bands here
