...
As a baseline, we timed the naive, sequential CPU implementation of SoftDTW.

\begin{figure}[htbp]
    \begin{center}
        \input{fig/plot_cpu.pgf}
    \end{center}
    \caption{Sequential CPU performance on random unit normal time series length
      = 100}
    \label{plot_cpu}
\end{figure}
...
\begin{figure}[htbp]
    \begin{center}
        \input{fig/plot_naive_multi_bw.pgf}
    \end{center}
